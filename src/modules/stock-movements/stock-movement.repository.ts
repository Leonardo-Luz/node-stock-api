...
export class StockMovementRepository {
  ...
  async create(createStockMovementDto: CreateStockMovementDto) {
    const stockMovement = await this.stockMovementModel.create(createStockMovementDto);
  ...
  async delete(id: string) {
    const stockMovement = await this.stockMovementModel.findByIdAndDelete(id).lean();
